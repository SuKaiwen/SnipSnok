...
import static snipsnok.constants.SecurityConstants.*;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            snipsnok.user.User applicationUser = new ObjectMapper().readValue(req.getInputStream(), snipsnok.user.User.class);
